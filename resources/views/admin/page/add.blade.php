...
<div class="row">
    <div class="col-12">
      <form method="post" action="{{url('dashboard/page/submit')}}" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i>Add Page Information</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3">
                  ...
                  <div class="col-sm-7">
                    <textarea class="form-control form_control" name="remarks">{{old('remarks')}}</textarea>
                  </div>
              </div>
            </div>
