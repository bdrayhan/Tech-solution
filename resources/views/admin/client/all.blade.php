            ...
            <div class="card-header card_header">
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <a href="{{url('dashboard/client/add')}}" class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-plus-circle label-icon"></i>Add Client</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table id="alltableinfo" class="table table-bordered table-striped table-hover dt-responsive nowrap custom_table">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                            @if($data->client_logo!='')
                              <img class="img-thumbnail img40" src="{{asset('uploads/client/'.$data->client_logo)}}"/>
                            @else
                          ...
                          <td>
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item" href="{{url('dashboard/client/view/'.$data->client_slug)}}">View</a>
                                  <a class="dropdown-item" href="{{url('dashboard/client/edit/'.$data->client_slug)}}">Edit</a>
                                  <a class="dropdown-item" href="#" id="softDelete" title="delete" data-toggle="modal" data-target="#softDelModal" data-id="{{$data->client_id}}">Delete</a>
                              </div>
                            </div>
                          </td>
                      </tr>
