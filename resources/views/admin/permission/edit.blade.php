      ...
      <form method="post" action="{{url('dashboard/permission/update')}}" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Update Permission Information</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('guard') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" name="guard" value="{{$data->guard_name}}">
                    @if ($errors->has('guard'))
                        <span class="invalid-feedback" role="alert">
              ...
              <div class="form-group row mb-3 {{ $errors->has('module') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-4">
                    ...
                    <select class="form-control form_control" name="module">
                      ...
                      <option value="{{$mod->module_id}}" @if($mod->module_id==$data->module_id) selected @endif>{{$mod->module_name}}</option>
                      @endforeach
                    </select>
