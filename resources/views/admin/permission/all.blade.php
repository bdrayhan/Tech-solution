    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> All Permission Information</h4>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{url('dashboard/permission/add')}}" class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-plus-circle label-icon"></i>Add Permission</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table id="alltableinfo" class="table table-bordered table-striped table-hover dt-responsive nowrap custom_table">
                    ...
                    <tbody>
                      @foreach($all as $data)
                      <tr>
                          <td>{{$data->moduleInfo->module_name}}</td>
                          <td>{{$data->name}}</td>
                          ...
                          <td>
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item" href="{{url('dashboard/permission/view/'.$data->slug)}}">View</a>
                                  <a class="dropdown-item" href="{{url('dashboard/permission/edit/'.$data->slug)}}">Edit</a>
