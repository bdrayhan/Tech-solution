      ...
      <form method="post" action="{{url('dashboard/banner/update')}}" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Update Banner Information</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" name="button" value="{{$data->ban_button}}">
                  </div>
              </div>
              <div class="form-group row mb-3">
              ...
              <div class="form-group row mb-3 {{ $errors->has('pic') ? ' has-error' : '' }}">
                  ...
                  <div class="col-md-2">
                    @if($data->ban_image!='')
                      <img class="img-thumbnail img100" src="{{asset('uploads/banners/'.$data->ban_image)}}"/>
                    @else
