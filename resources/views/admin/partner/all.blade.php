    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> All Partner Information</h4>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{url('dashboard/partner/add')}}" class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-plus-circle label-icon"></i>Add Partner</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                      ...
                      <tr>
                          ...
                          <td>
                            @if($data->partner_logo!='')
                              <img class="img-thumbnail img40" src="{{asset('uploads/partners/'.$data->partner_logo)}}"/>
                            @else
                          ...
                          <td>
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item" href="#" id="softDelete" title="delete" data-toggle="modal" data-target="#softDelModal" data-id="{{$data->partner_id}}">Delete</a>
                              </div>
                            </div>
                          </td>
                      </tr>
