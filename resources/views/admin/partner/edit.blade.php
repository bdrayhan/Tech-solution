      ...
      <form method="post" action="{{url('dashboard/partner/update')}}" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i>Add Partner Information</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('title') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    ...
                    <input type="text" class="form-control form_control" name="title" value="{{$data->partner_title}}">
                    @if ($errors->has('title'))
              ...
              <div class="form-group row mb-3">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" name="url" value="{{$data->partner_url}}">
                  </div>
              </div>
              <div class="form-group row mb-3 {{ $errors->has('pic') ? ' has-error' : '' }}">
                  ...
                  <div class="col-md-2">
                    @if($data->partner_logo!='')
                      <img class="img-thumbnail img100" src="{{asset('uploads/partners/'.$data->partner_logo)}}"/>
                    @else
