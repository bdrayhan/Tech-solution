...
<div class="row">
    <div class="col-12">
      <form method="post" action="{{url('dashboard/testimonial/submit')}}" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Add Client Testimonial Information</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('feedback') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <textarea class="form-control form_control" name="feedback" rows="5">{{old('feedback')}}</textarea>
