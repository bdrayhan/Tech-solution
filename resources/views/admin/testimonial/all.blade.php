    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> All Client Testimonial Information</h4>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{url('dashboard/testimonial/add')}}" class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-plus-circle label-icon"></i>Add Testimonial</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table id="alltableinfo" class="table table-bordered table-striped table-hover dt-responsive nowrap custom_table">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td>{{Str::limit($data->tm_feedback,30)}}</td>
                          <td>{{$data->tm_order}}</td>
                          <td>
                            @if($data->tm_photo!='')
                              <img class="img-thumbnail img40" src="{{asset('uploads/testimonial/'.$data->tm_photo)}}"/>
                            @else
                          ...
                          <td>
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item" href="{{url('dashboard/testimonial/view/'.$data->tm_slug)}}">View</a>
                                  <a class="dropdown-item" href="{{url('dashboard/testimonial/edit/'.$data->tm_slug)}}">Edit</a>
                                  <a class="dropdown-item" href="#" id="softDelete" title="delete" data-toggle="modal" data-target="#softDelModal" data-id="{{$data->tm_id}}">Delete</a>
                              </div>
                            </div>
                          </td>
                      </tr>
