    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> View Gallery Image Information</h4>
                    </div>
                          ...
                          <tr>
                            ...
                            <td>
                              @if($data->gallery_image!='')
                                <img class="img-thumbnail img200" src="{{asset('uploads/gallery/'.$data->gallery_image)}}"/>
                              @else
