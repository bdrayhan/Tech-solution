      ...
      <form method="post" action="{{url('dashboard/gallery/update')}}" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Update Gallery Image Information</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('title') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    ...
                    <input type="text" class="form-control form_control" name="title" value="{{$data->gallery_title}}">
                    @if ($errors->has('title'))
              ...
              <div class="form-group row mb-3 {{ $errors->has('category') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    ...
                    <select class="form-control form_control" name="category">
                      ...
                      <option value="{{$cate->galcate_id}}" @if($data->galcate_id==$cate->galcate_id) selected @endif>{{$cate->galcate_name}}</option>
                      @endforeach
                    </select>
              ...
              <div class="form-group row mb-3 {{ $errors->has('order') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" name="order" value="{{$data->gallery_order}}">
                  </div>
              </div>
              <div class="form-group row mb-3">
                  <label class="col-sm-3 col-form-label col_form_label">Remarks:</label>
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" name="remarks" value="{{$data->gallery_remarks}}">
                  </div>
              </div>
              <div class="form-group row mb-3 {{ $errors->has('pic') ? ' has-error' : '' }}">
                  ...
                  <div class="col-md-2">
                    @if($data->gallery_image!='')
                      <img class="img-thumbnail img100" src="{{asset('uploads/gallery/'.$data->gallery_image)}}"/>
                    @else
