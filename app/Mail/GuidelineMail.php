...
class GuidelineMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject('Guideline Mail')
                    ->view('admin.newsletter.guideline',compact('name','email','message')); // The view containing email content
    }
